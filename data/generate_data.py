...
#Common columns between historical and recent data API
...
Bhagalpur_recent = pd.read_excel('recent/Bhagalpur_recent.xlsx', usecols = cols_recent)
...
Bhojpur_recent = pd.read_excel('recent/Bhojpur_recent.xlsx', usecols = cols_recent)
...
East_Champaran_recent = pd.read_excel('recent/East_Champaran_recent.xlsx', usecols = cols_recent)
...
Kishanganj_recent = pd.read_excel('recent/Kishanganj_recent.xlsx', usecols = cols_recent)
Munger_historical = pd.read_csv('historical/Munger_2_10-31-2009_11-01-2019_hourly.csv', usecols= cols_historical, engine='python')
Munger_recent = pd.read_excel('recent/Munger_recent.xlsx', usecols = cols_recent)
...
Muzzafarpur_recent = pd.read_excel('recent/Muzzafarpur_recent.xlsx', usecols = cols_recent)
...
Vaishali_recent = pd.read_excel('recent/Vaishali_recent.xlsx', usecols = cols_recent)
...
#Getting the historical data with correct columns and converting the time to unix
...
#Getting the historical data with correct columns
counter = 0 
...
#Multiplying weather data by 4 (works in combining bc each weather data has 4)
